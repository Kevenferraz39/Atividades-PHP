                ...
                <nav class="dp-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Aula-07</a>
                            ...
                            <ul>
                            <li><a href="../aula-08/caraoucoroa.php">Cara ou coroa</a>
                        </li>            
                    </ul>
                </li>
...
<form action="" method="POST">
   <h2>voce quer:</h2><br>
<input type="radio" name="escolha" value="Cara">
<label><b>Cara</b></label>
<span>&nbsp;ou&nbsp;</span>
<label><b>Coroa</b></label>
<input type="radio" name="escolha" value="Coroa"><BR></BR>
<input type="submit" value="verificar">
       ...
       if($op=="Cara" && $moeda==1){
            echo"Deu cara você ganhou<br>";
            echo"<img src=\"../_img/coroa.png\" alt=\"moeda\">";
       }
    else if ($op=="Coroa" && $moeda==2){
        echo"Deu coroa você ganhou<br>";
        echo"<img src=\"../_img/cara.png\" alt=\"moeda\">";
    }
    else{
        if($moeda==1){
            echo"Você perdeu!!!<br>";
    ...
    <script src="../aula-08/../js/script.js"></script>
</body>
</html>