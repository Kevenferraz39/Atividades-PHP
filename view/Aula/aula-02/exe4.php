...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao Exercicio-04');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<nav class="sidebar close">
  ...
  <center><form action="" method="post">
     ...
     <select name="moeda" id="moeda">
        ...
        <span> valor a ser convertido (em reais):</span><br>
        <input type="text" name="valor" id="valor" placeholder="Digite o Valor"><br><br>
    ...
    echo" O valor convertido foi:$conv";
          ?>
          <br>
