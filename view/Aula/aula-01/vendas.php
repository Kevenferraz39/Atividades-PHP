...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo a Vendas');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<nav class="sidebar close">
 ...
 <center><form  method="post">
       <label for="Digite o valor">JAN</label><br>
       <input type="text" name="TXTFev"><br>

       <label for="Digite a Altura">FEV</label><br>
       <input type="text" name="TXTJan"><br>

       <label for="Digite a Altura">MAR</label><br>
       <input type="text" name="TXTMar"><br><br>
...
if ($media>1000){
    echo" <br> atingiu a meta ";
}
else if ($media<=1000){
    echo" <br> nao bateu a meta";
}
