...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao Operacao');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">  
<head>
...
<center>
    <fieldset style="width:400px; height:220px; border-radius: 5px; "><br><br>
         <form method="post" action="">
            <select name="slop" id="">
                 <option >Selecione</option>
                 <option value="1">soma</option>
                 <option value="2">sobtração</option>
        ...
        <input type="submit" name="btn" value="calcular" style="background-color:#1C214D; border-radius: 5px; color: white; padding:2px;">
        </form>
    </fieldset> 
</center>           
          <?php
