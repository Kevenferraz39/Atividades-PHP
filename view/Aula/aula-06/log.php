...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao Exercicio loguin');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">  
<head>
...
<center> 
    <fieldset style="width:400px; height:150px; border-radius: 5px; "><br><br>
        <form action="" method="post">
          <label for="">Usuario:</label>
          <input type="text" name="u" placeholder="Digite seu nome....."><br><br>
          <label for="">Senha:</label>
          <input type="password" name="s" placeholder="Digite sua senha....."><br><br>
        ...
        if(($S==1234)&&($U=="administrador")){
            echo"<center>Seja bem vindo!<br></center>";
        }
        else{
            echo"<center>Usuário inválido!<br></center>";
        }
        ?>
