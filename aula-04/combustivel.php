...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao exercicio combustivel');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
            ...
            <div class="topo">
                <nav class="dp-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Aula-04</a>
                            <ul>
                                    <li><a href="teste1.php">Teste-01</a></li>
                                    <li><a href="teste2.php">Teste-02</a></li>
                                    <li><a href="teste3.php">Teste-03</a></li>
                                    
                                    <li><a href="lanchotee.php">Lanchonete-01</a></li>
