...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao Media');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">  
<head>
...
<center>
    <fieldset style="width:50%; height:43%; border-radius: 5px;border-style:none; box-shadow: -1px 0px 25px 10px  #1C214D ;"><br><br>
        <form  method="post">
            <label for="">Aluno:&nbsp;&nbsp;</label>
            <input style="border-radius: 5px;padding:5px; width:40%;" type="text" name="aluno" placeholder="Digite o nome do aluno...."><br><br>
            <label for="Digite o valor">Nota-01</label>
            <input style="border-radius: 5px;padding:5px; width:40%;" type="text" name="TXT1"><br><br>

            <label for="Digite a Altura">Nota-02</label>
            <input style="border-radius: 5px;padding:5px; width:40%;" type="text" name="TXT2"><br><br>

            <label for="Digite a Altura">Nota-03</label>
            <input style="border-radius: 5px;padding:5px; width:40%;" type="text" name="TXT3"><br><br>

            <input type="submit" name="BTnCalcular" value="Calcular media" style="background-color:#1C214D; border-radius: 5px; color: white; padding:5px;
            width:40%;">
        </form>
    </fieldset>
</center> 
...
if ($media>=7){
    echo"Condicao: Aprovado!";
}
else if (($media>=5)&&($media<7)){
    echo"Condicao: Recuperação!";
}
else if($media<5){
    echo"Condicao: Reprovado!";
}
...
<br>
    ...
    <script src="../aula-06/../js/script.js"></script>
</body>
</html>