...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao Exercicio-03');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<nav class="sidebar close">
   ...
   <center><form action="" method="post">
        <input type="text" name="N1" placeholder="Digite o numero 1"><br><br>

        <input type="text" name="N2" placeholder="Digite o numero 2"><br><br>

        <input type="text" name="N3" placeholder="Digite o numero 3"><br><br>
