...
<?php
include('../protect.php');
echo"<script>alert('Bem vindo ao IMC');</script>";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<center>
      <form  action="" method="post"> 
       <label for="Digite o Peso">Digite o Peso</label><br>
       <input type="text" name="TXTPeso"><br>

       <label for="Digite a Altura">Digite a Altura</label><br>
       <input type="text" name="TXTAltura"><br><br>

       <label for=""name="N2" class="lb">Seu IMC e</label><br>
       <?php
